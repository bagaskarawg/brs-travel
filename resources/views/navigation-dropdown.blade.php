            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(Auth::user()->isAdmin())
                        ...
                        <x-jet-nav-link href="{{ route('schedules.index') }}" :active="request()->routeIs('schedules*')">
                            {{ __('Schedules') }}
                        </x-jet-nav-link>
                        ...
                        <div class="inline-flex items-center px-1 pt-1">
                            <x-jet-dropdown align="right">
                                ...
                                <x-slot name="content">
                                    <x-jet-dropdown-link href="{{ route('galleries.index') }}">
                                        Galeri
                                    </x-jet-dropdown-link>
                                    <x-jet-dropdown-link href="{{ route('promos.index') }}">
                                        Promo
                                    </x-jet-dropdown-link>
                                    <x-jet-dropdown-link href="{{ route('facilities.index') }}">
                                        Fasilitas
                                    </x-jet-dropdown-link>
                                    <x-jet-dropdown-link href="{{ route('posts.index') }}">
                                        Post
                                    </x-jet-dropdown-link>
                                    <x-jet-dropdown-link href="{{ route('testimonials.index') }}">
                                        Testimonial
                                    </x-jet-dropdown-link>
                                </x-slot>
                            </x-jet-dropdown>
