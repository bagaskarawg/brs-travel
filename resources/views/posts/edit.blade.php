                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="title" name="title" type="text" class="mt-1 block w-full" value="{{ $post->title }}" />
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <textarea class="form-input rounded-md shadow-sm mt-1 block w-full" name="body">{{ $post->body }}</textarea>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="published_at" type="datetime-local" class="mt-1 block w-full" name="published_at" value="{{ optional($post->published_at)->format('Y-m-d\TH:i') }}" />
