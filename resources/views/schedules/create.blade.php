                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <select id="day" name="day" class="form-input rounded-md shadow-sm mt-1 block w-full">
                                            @for($day = 0; $day < 7; $day++)
                                                <option value="{{ $day }}">{{ App\Models\Schedule::DAYS[$day] }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="departure" type="time" class="mt-1 block w-full" name="departure" />
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="arrival" type="time" class="mt-1 block w-full" name="arrival" />
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-4">
                                        ...
                                        <x-jet-input id="passenger_capacity" type="number" value="0" class="mt-1 block w-full" name="passenger_capacity" />
